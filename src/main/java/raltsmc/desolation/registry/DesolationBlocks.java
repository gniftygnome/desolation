...
public final class DesolationBlocks {
    ...
    public static final Block SCORCHED_TUFT = register(new ScorchedTuftBlock(FabricBlockSettings.copyOf(Blocks.SHORT_GRASS).mapColor(MapColor.GRAY).sounds(BlockSoundGroup.CROP)), "scorched_tuft", true);
    ...
    public static final Block CHARRED_SAPLING = register(new CharredSaplingBlock(new SaplingGenerator("charred", Optional.empty(), Optional.of(DesolationConfiguredFeatures.TREE_CHARRED), Optional.empty()), FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)), "charred_sapling", true);
    ...
    public static final Block CHARRED_STAIRS = register(new StairsBlock(CHARRED_PLANKS.getDefaultState(), FabricBlockSettings.copyOf(CHARRED_PLANKS)), "charred_stairs", true);
    public static final Block CHARRED_PRESSURE_PLATE = register(new PressurePlateBlock(DesolationBlockSets.CHARRED, FabricBlockSettings.copyOf(Blocks.OAK_PRESSURE_PLATE).mapColor(MapColor.GRAY)), "charred_pressure_plate", true);
    public static final Block CHARRED_TRAPDOOR = register(new TrapdoorBlock(DesolationBlockSets.CHARRED, FabricBlockSettings.copyOf(Blocks.OAK_TRAPDOOR).mapColor(MapColor.GRAY).strength(3.0f).allowsSpawning((state, world, pos, entityType) -> false)), "charred_trapdoor", true);
    ...
    public static final Block CHARRED_FENCE_GATE = register(new FenceGateBlock(WoodType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_FENCE_GATE).mapColor(MapColor.GRAY)), "charred_fence_gate", true);
    public static final Block CHARRED_BUTTON = register(new ButtonBlock(DesolationBlockSets.CHARRED, 30, FabricBlockSettings.copyOf(Blocks.OAK_BUTTON).mapColor(MapColor.GRAY)), "charred_button", true);
    public static final Block CHARRED_DOOR = register(new DoorBlock(DesolationBlockSets.CHARRED, FabricBlockSettings.copyOf(Blocks.OAK_DOOR).mapColor(MapColor.GRAY)), "charred_door", false);
